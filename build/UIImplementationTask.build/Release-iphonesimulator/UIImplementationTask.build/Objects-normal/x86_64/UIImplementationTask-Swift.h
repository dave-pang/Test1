...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UIImplementationTask",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20UIImplementationTask11AppDelegate")
...
SWIFT_CLASS("_TtC20UIImplementationTask10ModelView1")
@interface ModelView1 : UIView
...
SWIFT_CLASS("_TtC20UIImplementationTask10ModelView2")
@interface ModelView2 : UIView
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified button;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC20UIImplementationTask10ModelView3")
@interface ModelView3 : UIView
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified titleLabel;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC20UIImplementationTask20MutipleCellViewModel")
@interface MutipleCellViewModel : NSObject
...
@interface MutipleCellViewModel (SWIFT_EXTENSION(UIImplementationTask)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC20UIImplementationTask13SceneDelegate")
...
SWIFT_CLASS("_TtC20UIImplementationTask14TableViewCell1")
...
SWIFT_CLASS("_TtC20UIImplementationTask14TableViewCell2")
...
SWIFT_CLASS("_TtC20UIImplementationTask14TableViewCell3")
...
SWIFT_CLASS("_TtC20UIImplementationTask14ViewController")
